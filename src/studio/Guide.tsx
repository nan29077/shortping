...
export const lessons = [
  {
    ...
    tip: '빠른 제작도 먼저 예상 라마와 최대 사용량을 확인하세요. 첫 작품은 단계별 제작을 추천해요.',
    sample:
  ...
  },
  {
    ...
    steps: [
      ...
      '기획 · 설정 탭에서 아이디어를 적으면 자동으로 저장돼요. AI 기획안으로 제목·줄거리·인물·회차 구성을 만들고, 원작이 있다면 원작 각색을 써 보세요.',
      '설정집(세계관·말투·복선)과 시즌 설계(회차별 훅·클리프행어·유료 시작 회차)를 정하면 회차끼리 잘 이어져요.',
    ],
    tip: '입력은 자동으로 저장돼요. 칸 옆의 ‘저장됨’ 표시를 확인하세요.',
    sample:
  ...
  },
  {
    ...
    steps: [
      '이름·역할·성격·외모·기본 의상을 입력하세요. 외모는 한국어로 써도 영어로 바꿔 전달해요.',
      '기준 이미지를 만든 뒤 얼굴과 의상을 확인하세요. AI 결과가 항상 같지는 않으므로 다음 장면도 확인해야 해요.',
      '참고 이미지 세트(정면·옆·전신·표정)를 만들면 장면마다 얼굴이 더 잘 맞아요. 목소리 라이브러리에서 성별·나이대로 골라 바로 들어 보세요(미리듣기는 무료).',
    ],
  ...
  },
  {
    ...
    steps: [
      '대본 탭에서 회차를 고르고 AI 대본을 만들거나 컷을 직접 추가하세요. 요청 사항 칩(첫 3초 강렬하게 등)으로 방향을 정할 수 있어요.',
      '장면 설명은 이야기, 화면 묘사는 실제 보일 모습, 대사는 인물이 말하는 내용이에요.',
      '대본 진단으로 훅·전개·대사 점수와 고칠 곳을 확인하고, 마음에 안 드는 구간만 골라 다시 쓰세요. 예전 대본은 버전 기록에서 되돌릴 수 있어요.',
    ],
  ...
  },
  {
    ...
    steps: [
      '장면 편집 탭에서 ‘빈 이미지’로 스토리보드를 한 번에 채우세요. 타임라인에서 컷을 눌러 하나씩 다듬을 수 있어요.',
      '대사 음성을 만들고 감정·말 빠르기를 조절하세요. 이미지는 ‘이미지 고치기’로 일부만 바꾸고, 시드 고정으로 비슷한 그림을 유지할 수 있어요.',
  ...
  },
  {
    ...
    steps: [
      ...
      '완성 · 공개 탭에서 회차를 합성하세요. 배경음악·효과음·자막 모양·오프닝/엔딩 카드도 함께 들어가요.',
      '썸네일 꾸미기로 제목을 올린 포스터를 만들고, 후보를 여러 장 고르면 공개 후 가장 잘 눌리는 이미지를 자동으로 찾아요. 수정한 컷은 다시 합성해야 반영돼요.',
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      '권리 보유·초상권·AI 사용 여부를 확인하고 심사를 신청하세요. 공개 중인 작품에 새 회차를 더하면 그 회차만 따로 검수받고, 원하는 시각에 공개되게 예약할 수 있어요.',
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      '작업 실패: 실패 이유와 반환 내역을 확인하고 입력을 줄이거나 다른 모델을 선택하세요. 빠른 제작이 멈추면 원인을 해결한 뒤 다시 시작하세요.',
    ],
...
const faqs = [
  ...
  [
    '빠른 제작 버튼을 누르면 바로 공개되나요?',
    '아니요. 빠른 제작은 회차 합성까지 도와줘요. 결과 확인, 포스터 선택, 작품 내보내기와 심사 요청이 필요해요.',
  ],
  [
    '예전 이미지가 더 마음에 들어요.',
