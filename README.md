...
| 업로더 (PD) | 내 작품 대시보드, 작품 등록·수정, 표지 업로드, 여러 회차 분할·이어 업로드·자막·권리/AI 신고, 숏핑 스튜디오(AI 드라마 제작)·라마 지갑, 심사 요청, 반려 의견, 마이 방송국(배너·카테고리·진열), 정산 달력·출금 신청, 세무 정보 |
...
2. 핑을 충전해 잠긴 회차를 열거나 작품 전체를 할인가로 열고, 마이페이지에서 보유 핑·결제·핑 내역 확인. 숏핑 패스를 구매하면 모든 작품 시청 가능. 핑 설계는 `docs/PINGS.md`, AI 제작·라마·업로드는 `docs/STUDIO.md` 참고.
